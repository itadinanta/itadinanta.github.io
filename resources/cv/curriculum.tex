...
\begin{document}
    ...
    \cvHeader{Nico Orr\`u}{Senior Principal Programmer}
    ...
    \section{Published Titles}
        ...
        \cvPublishedTitles{
            \cvPublishedTitle{Climate Station}{PS5/PSVR2}{prototype technical director, IVT}
            ...
            \cvPublishedTitle{DRIVECLUB VR}{PSVR launch title}{principal programmer, maintainer, acting producer}
    ...
    \section{Knowledge}
        ...
        \subsection{Programming and scripting languages}
            \cvItemList{
                \cvItem{\cvEmph{Recently:} \cvEmph{C++, Go, Java}, Bash, PowerShell, Python, C\#, Lua, Rust, Kotlin}

                \cvItem{\cvEmph{Historically:} Elm, F\#, Ruby, Erlang, C, JavaScript, Scala, SQL, Julia,
        ...
        \subsection{Tools and methodologies}
            \cvItemList{
                ...
                \cvItem{\cvEmph{Proprietary engines (incl. DECIMA)}, \cvEmph{Unity}, \cvEmph{Unreal Engine}, ECS model}
                ...
                \cvItem{OpenGL, GTK, ImGui, gfx-rs, OpenFX, Vulkan Compute, OpenCV, Nuke (VFX and film editing software)}
...
%            }
    ...
    \section{History}
        \cvHistoryYears{2024-present}{
            \cvEmph{Senior Principal Online Server Engineer} at Guerrilla (Amsterdam, NL), Sony Interactive Entertainment PlayStation Studios
            (remote from PlayStation Liverpool, UK)
        }{
            \cvHistoryItem{Design, development and integration of bespoke game services for unannounced multiplayer title}
        }{
        }
        ...
        \cvHistoryYears{2021-2024}{
            ...
            terminated due to studio closure
        }{
            \cvHistoryItem{Server architecture and microservices development (Go) on AWS EKS – following CNCF principles
            and guidelines}
            \cvHistoryItem{Client netcode to support rollback-based P2P cross-platform (PC/PS5) communication}
        ...
        \cvHistoryYears{2017-2021}{
            ...
            \cvHistoryAchievement{Released titles}{Joshua Bell VR, Wipeout Omega Collection, Tom Grennan VR, Climate
            Station}
        ...
        \cvHistoryYears{2004-2010}{
            \cvEmph{Programmer, Senior Programmer} at Sony Computer Entertainment Europe Studio Liverpool (UK) with a
    ...
    \section{Education}
        \cvHistoryYears{2000}{
            \cvEmph{\textit{Diploma Universitario in Informatica}} from the \textit{University of Cagliari}, Italy (3 years, Computer Science), with a final mark of
            \cvEmph{70/70 cum laude}
        }{}{}

        \cvHistoryYears{1992}{
            \cvEmph{\textit{Diploma di Maturit\`a Tecnica Industriale specializzazione
            Informatica}} obtained from \textit{Istituto Tecnico Industriale “Dionigi Scano”}, Italy (technical high school, 5 years, Computer Science)
            with a mark of \cvEmph{60/60} in the final exam
        }{}{}
